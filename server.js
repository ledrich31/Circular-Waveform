...
// This will now correctly serve index.html for the '/' route,
// as well as all other static files like script.js, p5.js, etc.
...
app.post('/api/send-waveform', async (req, res) => {
  ...
  sgMail.send(msg)
    ...
    .catch((error) => {
      ...
      // Return 200 because save succeeded; but indicate email error
